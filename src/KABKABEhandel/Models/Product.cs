...
namespace KABKABEhandel.Models
{
    ...
    {
        public Product(int categoryId, string name, decimal price, int numberInStock, int id, string description, double discount, bool isActive, string imageURL, double vat)
        {
